...
$.ajaxPrefilter('script', function(s) {
	if (!jQuery.migrateMute && s.url.indexOf('cargurus') >= 0) {
		var styles = ['color: red', 'line-height: 40px', 'font-weight: bold'].join(
			';'
		)
		console.log(
			'%c Synchronous XMLHttpRequest on the main thread is deprecated because of its detrimental effects to the end user\'s experience. For more help, check https://xhr.spec.whatwg.org/.',
			styles
		)
		throw new Error(
			'Synchronous ajax scripts are not supported.\n Script: ' + s.url
		)
	}
})
